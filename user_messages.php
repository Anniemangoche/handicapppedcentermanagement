...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Donor"; // Set subject to "Donor" always
    ...
    if ($stmt === false) {
        ...
        if ($stmt->execute()) {
            $submission_message = "Message sent successfully as Donor!";
...
$conn->close(); // Close connection is moved outside try-catch for mysqli
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Contact Us - Donor Message</title>
    ...
    <style>
        ...
        * {
        ...
        /* Style for the message form container */
        ...
        .message-form-container p {
            text-align: center;
            margin-bottom: 20px;
            color: green; /* Or error color if needed */
        }
...
<body>
    <div class="dashboard">
        ...
        <aside class="sidebar">
            ...
            <li><a href="user_messages.php" class="active"><i class="fas fa-envelope"></i> message</a></li>
        ...
        <main class="main-content">
            ...
            <header class="topbar">
                ...
                <h1>Contact Us - Donor Message</h1>
            ...
            <div class="message-form-container">
                <h2>Send us a Message as Donor</h2>
